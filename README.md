...
**Framework 2.0.0** prepares realistic research conversations and an external evidence/assessment workflow. Begin with a scientific question; develop a useful first investigation through native Plan first, execution and runtime auto-review; decide on extensions from the findings.
...
Release tags: `archive-pre-conversation-20260916` for the preparation baseline; `framework-v2.0.0` for this release. Report research usefulness, scientific validity, observed product features and Reproduction consistency separately. Consult [CHANGELOG](CHANGELOG.md) for the transition.
