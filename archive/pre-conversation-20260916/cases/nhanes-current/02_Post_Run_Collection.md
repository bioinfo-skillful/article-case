...
Act as **Human Review** for `E:/codex/open-science-server/cases/nhanes-2015-2016-smoking-phq9`, attempt `run_001`. Read START, 03, 04 and the master checklist in the design-basis directory. Collect only materials from the registered workspace/session. Preserve source files. Do not restart scientific analysis, overwrite failures or initial versions, or send this document to OpenScience.
