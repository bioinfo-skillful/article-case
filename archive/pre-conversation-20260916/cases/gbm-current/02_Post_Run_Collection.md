# GBM-001 / upgraded protocol：外部收集与核验提示词


对 E:/codex/open-science-server/cases/gbm-clinical-trial-landscape 的 run_NNN 承担人工审核。读取 START、03、04 和设计依据的运行契约/证据矩阵；只整理本次登记的真实材料。此说明不提供给 OpenScience，也不授权重新启动分析或修改科学输出。
...
按实际存在材料建立 `human_records/run_NNN/collection_<timestamp>/`：
